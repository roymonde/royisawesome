...
local leonflix          = "/opt/appimage/Leonflix.AppImage"
local youtube           = "/opt/google/chrome/google-chrome --profile-directory=Default --app-id=adnlfjpnmidfimlkaohpidplnoimahfh"
local prime             = "/opt/google/chrome/google-chrome --profile-directory=Default --app-id=ofgkhacfboakfbfibkifabklhokjnpll"
local netflix           = "/opt/google/chrome/google-chrome --profile-directory=Default --app-id=eppojlglocelodeimnohnlnionkobfln"
...
globalkeys = my_table.join(
  ...
  awful.key({ modkey }, "x",  function () awful.util.spawn( "oblogout" ) end,
    ...
    awful.key({ altkey }, "1", function () awful.util.spawn( google ) end,
        {description = "google", group = "altkey"}),
    awful.key({ altkey }, "2", function () awful.util.spawn( youtube ) end,
        {description = "youtube", group = "altkey"}),
    awful.key({ altkey }, "3", function () awful.util.spawn( prime ) end,
        {description = "prime", group = "altkey"}),
    awful.key({ altkey }, "4", function () awful.util.spawn( netflix ) end,
        {description = "netflix", group = "altkey"}),
    awful.key({ altkey }, "5", function () awful.util.spawn( iplayer ) end,
        {description = "iplayer", group = "altkey"}),
    awful.key({ altkey }, "6", function () awful.util.spawn( od ) end,
        {description = "od", group = "altkey"}),
    awful.key({ altkey }, "7", function () awful.util.spawn( leonflix ) end,
        {description = "leonflix", group = "altkey"}),
    awful.key({ altkey }, "8", function () awful.util.spawn( filemanager ) end,
        {description = "thunar", group = "altkey"}),
    awful.key({ altkey }, "9", function () awful.util.spawn( "meld" ) end,
        {description = "meld", group = "altkey"}),
    awful.key({ altkey }, "0", function () awful.util.spawn( "blueberry" ) end,
